...
Original file is located at
    https://colab.research.google.com/drive/1_88tymROEfXOn5aXSD2SHYLZo2HKpj0e
"""
...
for sentence in raw_sentences_train_en:
    token_store = sentence.split(' ')
    tokenized_stores['en_train'].append(token_store)

for sentence in raw_sentences_train_hi:
    token_store = sentence.split(' ')
    tokenized_stores['hi_train'].append(token_store)

for sentence in raw_sentences_test_en:
    token_store = sentence.split(' ')
    tokenized_stores['en_test'].append(token_store)

for sentence in raw_sentences_test_hi:
    token_store = sentence.split(' ')
    tokenized_stores['hi_test'].append(token_store)
